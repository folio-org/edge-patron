...
public class MainVerticleTest {
  ...
  @Test
  public void testSecureGetAccount(TestContext context) throws Exception {
    final String expected = PatronMockOkapi.getAccountJson(patronId, false, false, false);
    RestAssured
      .given()
  ...
  @Test
  public void testSecureAllowedServicePointsSuccess(TestContext context) throws Exception {
