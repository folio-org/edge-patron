...
public final class Hold {
  ...
  public static class Builder {
    ...
    @JsonProperty("cancelationAdditionalInformation")
    ...
    public Builder cancelationDate(Date canceledDate) {
      this.canceledDate = canceledDate;
      return this;
    }

    public Builder cancelationReasonId(String cancellationReasonId) {
