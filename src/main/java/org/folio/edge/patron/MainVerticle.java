...
public class MainVerticle extends EdgeVerticleHttp {
  ...
  public Router defineRoutes() {
    ...
    router.route(HttpMethod.GET, "/patron/account/instance/:instanceId/" +
      "allowed-service-points").handler(patronHandler::handleSecureGetAllowedServicePointsForInstance);
    ...
    router.route(HttpMethod.GET, "/patron/account/item/:itemId/" +
      "allowed-service-points").handler(patronHandler::handleSecureGetAllowedServicePointsForItem);
